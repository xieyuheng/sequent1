...
* todo
  ...
  - check and pass3 must be interweaved
  ...
  - export apply to sequent1
    ...
    to apply is to form trunk
    maybe var in the arrow-list part of the trunk
...
*** [not-using] check/arrow without monad combinator
