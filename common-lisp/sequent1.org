...
*** vector
    ...
    eva/df fail to define :
    ((append (((v (m 0)) (v (t 0)) (n vector) (v (n 0)) (v (t 0)) (n vector)) ((v (m 0)) (v (n 0)) (n add) (v (t 0)) (n vector))))
     ((((n null) (v (l 0))) ((v (l 0))))
      (((v (l 0)) (v (e 0)) (n cons) (v (l1 0))) ((v (l 0)) (v (l1 0)) (n append) (v (e 0)) (n cons)))))
    ...
    ((check/arrow
      ...
      (sc
       ((var (#(l ((1 cons (vector ((var (#(t ((0 var (#(e nil) 1)))) 0)) (var (#(n nil) 0))))))) 0))
        (var (#(l1 nil) 0))
        (name append)
        (var (#(e nil) 0))
        (name cons)
